...
public class LineChartData {
	...
	public void addLine(List<Float> yVal,int color)
	{
		if(yVal == null)
			return;
		LineInfoData data = new LineInfoData(yVal,color, false, false);
...
//            set1.enableDashedHighlightLine(10f, 5f, 0f);
			...
			set.setDrawCircleHole(lineInfoData.mDrawCircleHole);//设置是否空心圆
			set.setValueTextSize(9f);
			set.setDrawValues(false);

			//设置线下面的阴影颜色
			set.setDrawFilled(lineInfoData.mDrawFilled);
			set.setFillColor(lineInfoData.mLineColor);
