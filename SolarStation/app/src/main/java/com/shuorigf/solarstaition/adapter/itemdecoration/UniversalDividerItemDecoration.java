package com.shuorigf.solarstaition.adapter.itemdecoration;
...
public class UniversalDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public UniversalDividerItemDecoration(Context context, int orientation) {
     ...
     */
    public UniversalDividerItemDecoration(Context context, int orientation, int drawableId) {
        this.setOrientation(orientation);
